...
class PackageScanningTest {
    ...
    fun `scan package finds annotated classes`() {
        ...
        val definitions = scanner.scan("org.berrycrush.step.testscanner")
    ...
    fun `scan package returns empty for package without steps`() {
        ...
        val definitions = scanner.scan("org.berrycrush.nonexistent")
    ...
    fun `scan multiple packages`() {
        val definitions =
            scanner.scanAll(
                "org.berrycrush.step.testscanner",
                "org.berrycrush.step.testscanner2",
            )
