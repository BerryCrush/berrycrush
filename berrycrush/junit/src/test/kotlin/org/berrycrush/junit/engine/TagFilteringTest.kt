 ...
 *
 * This validates the @BerryCrushTags annotation handling and the
...
// They do NOT have @BerryCrushScenarios to prevent the berrycrush engine from discovering them.

private class NoTagsStub

@BerryCrushTags(include = ["smoke", "api"])
