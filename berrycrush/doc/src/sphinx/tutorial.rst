...
BerryCrush can automatically generate invalid request and security tests based on your OpenAPI schema.
...
* :doc:`features/plugins` - Extend BerryCrush with plugins
