...
class SpringBindingsProviderTest {
    ...
    @Test
    fun `supports returns true for class with BerryCrushContextConfiguration`() {
        assertTrue(provider.supports(ValidTestClass::class.java))
    }

    @Test
    fun `supports returns false for class without BerryCrushContextConfiguration`() {
    ...
    @Component
    @Lazy
    class TestBindingsComponent : BerryCrushBindings {
        @LocalServerPort
