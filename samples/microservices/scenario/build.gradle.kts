...
dependencies {
    // Test against both microservices
    testImplementation(project(":samples:microservices:order-service"))
    testImplementation(project(":samples:microservices:inventory-service"))
