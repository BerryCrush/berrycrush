...
LemonCheck provides multiple ways to define custom step definitions, allowing you to
...
LemonCheck can automatically discover step classes in specified packages:
