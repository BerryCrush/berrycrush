...
class JsonReportPlugin(
    outputPath: Path = Path.of("lemoncheck/report.json"),
    /**
    ...
    private fun toFailureJson(failure: io.github.ktakashi.lemoncheck.plugin.AssertionFailure): Map<String, Any?> =
        mapOf(
    ...
    private fun toRequestJson(request: io.github.ktakashi.lemoncheck.plugin.HttpRequest): Map<String, Any?> =
        mapOf(
    ...
    private fun toResponseJson(response: io.github.ktakashi.lemoncheck.plugin.HttpResponse): Map<String, Any?> =
        mapOf(
