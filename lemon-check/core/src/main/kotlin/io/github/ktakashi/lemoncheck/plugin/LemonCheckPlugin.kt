...
/**
 * Service Provider Interface (SPI) for lemon-check plugins.
 *
 * Allows users to extend lemon-check with custom lifecycle hooks that execute at key points
 ...
 * - Name-based: `@LemonCheckConfiguration(plugins = ["report:json:output.json"])`
 * - Class-based: `@LemonCheckConfiguration(pluginClasses = [MyPlugin::class])`
 * - SPI Discovery: `META-INF/services/io.github.ktakashi.lemoncheck.plugin.LemonCheckPlugin`
 *
 * @see ScenarioContext
 * @see StepContext
 * @see ScenarioResult
